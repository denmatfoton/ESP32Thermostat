...
#define CRITICAL_DEBUG_ENABLE

#ifdef CRITICAL_DEBUG_ENABLE
#ifdef __cplusplus
...
#define ESP32_CRITICAL_MUTEX        criticalMutex
...
#define gfxSystemLock()				taskENTER_CRITICAL(&ESP32_CRITICAL_MUTEX)
#define gfxSystemUnlock()			taskEXIT_CRITICAL(&ESP32_CRITICAL_MUTEX)
...
extern portMUX_TYPE ESP32_CRITICAL_MUTEX;
